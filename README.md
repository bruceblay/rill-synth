...
- **Flurries:** a melody note occasionally breaks into a few very fast repeats, sometimes alternating with the neighbouring scale tone, so it reads as a roll or a trill. Each repeat is quieter than the one before, a flurry never runs past the space before the next note, and only about half of generations do it at all.
